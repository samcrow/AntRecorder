...
ANT_RECORDER_NAME='$name$'

# cd to the location of this file
cd `dirname $0`
# Run the JAR file
/Library/Java/JavaVirtualMachines/$JAVA_INSTALL_TYPE$JAVA_VERSION.$JAVA_INSTALL_TYPE/Contents/Home/bin/java -jar $ANT_RECORDER_NAME-jfx.jar
